...
public class Example3 {
    ...
    public static int[] reconstructHotel(int[] array, int quantityRooms) {
        ...
        if (array.length < quantityRooms) {  // Хотим увеличить количество номеров
            ...
            int[] newHotel2= new int[quantityRooms];

            for (int i = 0; i < newHotel2.length; i++) { // копируем нужное количество человек из исходного массива
                newHotel2[i] = array[i];
            }

                return newHotel2; // пока возвращаем исходный массив в выше стоящий метод
